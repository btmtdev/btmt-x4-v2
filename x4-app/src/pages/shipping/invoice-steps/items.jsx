    ...
    <div className="flex flex-col p-4 h-full">
      <div className="flex-1 min-h-0">
        <AgGridReact theme={theme} rowData={bottomRows} pinnedTopRowData={pinnedRows} columnDefs={[
          ...
          { headerName: "QTY", flex: 0.7, type: "rightAligned", cellRenderer: p => p.data.selected ? <input type="number" className="w-16 border rounded px-1 text-right text-xs" value={p.data.qty_use} onChange={e => updateQty(p.data.so_key, p.data.so_line, e.target.value)} /> : "" },
