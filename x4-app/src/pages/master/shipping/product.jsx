...
const CONFIG = {
  ...
  fields: [
    ...
    { key: "description", label: "MASTER.DESCRIPTION", required: true },
    { key: "type", label: "MASTER.TYPE", type: "select", options: ["T", "C", "F"] },
    { key: "brand", label: "MASTER.BRAND", type: "select", options: ["BS", "FS", "DT"] },
    { key: "net_weight", label: "MASTER.NET_WEIGHT", type: "number", hideGrid: true },
    { key: "volume", label: "MASTER.VOLUME", type: "number", hideGrid: true },
    { key: "rubber", label: "MASTER.RUBBER", type: "number", hideGrid: true },
    { key: "coo_key", label: "MASTER.ORIGIN", type: "lookup", lookup: "countryOfOrigins", valueKey: "key", displayKey: "name" },
  ],
}
const TITLE_KEY = "MASTER.TITLE_PRODUCT"
...
export default function ProductPage() {
  ...
  async function save(e) {
    ...
    payload.group = code.substring(0, 3)
    if (payload.type === "T") {
      payload.coo_key = "L"
    } else if (code.length >= 5) {
      payload.coo_key = code[4]
    }
