          ...
          <form onSubmit={save} className="flex flex-col h-full">
            <div className="flex-1 overflow-y-auto p-5 space-y-3">
              <div className="space-y-1">
                <label className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">BOM KEY</label>
                <Input className="text-sm h-9 bg-muted/50" readOnly value={(form.tire || "") + (form.kit_key || "")} />
              </div>
              <div className="space-y-1">
                <label className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">SET CODE</label>
                <Input className="text-sm h-9" required value={form.kit_key ?? ""} onChange={e => setForm(p => ({ ...p, kit_key: e.target.value }))} />
              </div>
              <div className="space-y-1">
                <label className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">COMPONENT SET</label>
                <select className="w-full border border-border rounded-md px-3 py-2 text-sm bg-background h-9" required value={form.component_set ?? ""} onChange={e => setForm(p => ({ ...p, component_set: e.target.value }))}>
                  <option value="">-</option>
              ...
              <div className="space-y-1">
                <label className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">TIRE</label>
                <select className="w-full border border-border rounded-md px-3 py-2 text-sm bg-background h-9" value={form.tire ?? ""} onChange={e => setForm(p => ({ ...p, tire: e.target.value || null }))}>
                  <option value="">-</option>
              ...
              {(form.component_set === "TCF" || form.component_set === "TC") && (
                <div className="space-y-1">
                  <label className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">TUBE</label>
                  <select className="w-full border border-border rounded-md px-3 py-2 text-sm bg-background h-9" value={form.tube ?? ""} onChange={e => setForm(p => ({ ...p, tube: e.target.value || null }))}>
                    <option value="">-</option>
              ...
              {(form.component_set === "TCF" || form.component_set === "TF") && (
                <div className="space-y-1">
                  <label className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">FLAP</label>
                  <select className="w-full border border-border rounded-md px-3 py-2 text-sm bg-background h-9" value={form.flap ?? ""} onChange={e => setForm(p => ({ ...p, flap: e.target.value || null }))}>
                    <option value="">-</option>
