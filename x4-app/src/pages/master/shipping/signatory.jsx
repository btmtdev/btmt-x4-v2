                ...
                <div key={f.key} className="space-y-1">
                  ...
                  {f.type === "select" ? (
                    ...
                    <div className="space-y-2">
                      <label className="flex flex-col items-center justify-center gap-1 border-2 border-dashed border-border rounded-md p-4 cursor-pointer hover:bg-muted/30 hover:border-primary/50 transition-colors">
                        {form[f.key] ? (
                          ...
                          <>
                            ...
                            <span className="text-xs text-muted-foreground">{t("MASTER.UPLOAD_DESC")}</span>
                          </>
                        )}
                      ...
                      {form[f.key] && <button type="button" onClick={() => setForm(p => ({ ...p, [f.key]: null }))} className="text-xs text-destructive hover:underline">{t("MASTER.REMOVE")}</button>}
                    </div>
                  ) : (
