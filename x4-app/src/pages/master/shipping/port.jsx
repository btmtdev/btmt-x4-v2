              ...
              {CONFIG.fields.map(f => (
                <div key={f.key} className="space-y-1">
                  ...
                  {f.type === "checkbox" ? (
                    ...
                    <select className="w-full border border-border rounded-md px-3 py-2 text-sm bg-background h-9" value={String(form[f.key] ?? "")} onChange={e => { const v = e.target.value; setForm(p => ({ ...p, [f.key]: v === "true" ? true : v === "false" ? false : v || null })) }}>
                      <option value="">-</option>
