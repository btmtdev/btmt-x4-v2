...
export const adminService = {
  ...
  getTesters: () => request("/api/testers"),
  checkTester: (userKey) => request(`/api/testers/check/${userKey}`),
  addTester: (userKey) => request("/api/testers", { method: "POST", body: JSON.stringify({ user_key: userKey }) }),
  removeTester: (userKey) => request(`/api/testers/${userKey}`, { method: "DELETE" }),
}
