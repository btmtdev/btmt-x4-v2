  ...
  return (
    <div className="px-5 py-3 space-y-2">
      <div className="flex items-center justify-between">
        <span className="text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">{t("SUPPORT.ATTACHMENTS")}</span>
        {uploading && <span className="text-[10px] text-primary animate-pulse">{t("SUPPORT.UPLOADING")}</span>}
      </div>
      {files.length > 0 && (
